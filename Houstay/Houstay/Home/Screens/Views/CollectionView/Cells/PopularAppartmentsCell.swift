...
class PopularAppartmentsCell: UICollectionViewCell {
    static var reuseIdentifier = String(describing: PopularAppartmentsCell.self)
    ...
    internal var closure: ((PopularAppartmentsCell) -> Void)?
